      ...
      <div className="space-y-3">
        ...
        >
          ...
          <p className="text-muted-foreground text-xs">
            ...
            {formatDate(resume.updatedAt, "d MMM, yyyy h:mm a")}
          </p>
        </Link>
        <Link
          href={`/editor?resumeId=${resume.id}`}
...
function DeleteConfirmationDialog({
  ...
  //! Loading state for when the deletion is pending
  //! when calling a server action with revalidate path from a client component,
  //! we should wrap it with useTransition()
