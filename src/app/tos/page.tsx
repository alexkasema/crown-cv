...
const page = () => {
  return (
    <main className="mx-auto max-w-prose space-y-6 p-3 py-6">
      ...
      <p>
        Welcome to Crown CV. These Terms of Service (&quot;Terms&quot;) govern
        your use of our website and services, including any paid subscription
        plans. By accessing or using Crown CV (&quot;the Service&quot;), you
        agree to be bound by these Terms. If you do not agree to these Terms, do
        not use the Service.
      </p>
      <h2 className="text-xl font-semibold">1. Overview</h2>
      <p>
        Crown CV is a SaaS platform that provides resume-building tools powered
      ...
      <ul className="list-inside list-disc">
        ...
        <li>
          <strong>Refund Policy:</strong> Crown CV does not offer refunds for
      ...
      <p>
        Crown CV grants you a limited, non-exclusive, non-transferable, and
      ...
      <p>
        ...
        Resume Builder are owned by Crown CV or its licensors. You agree not to
        infringe on these rights.
      </p>
      <h2 className="text-xl font-semibold">10. User Content</h2>
      <p>
        By using the Service, you grant Crown CV a non-exclusive, worldwide,
      ...
      <p>
        ...
        services (e.g., Stripe for payments). Crown CV is not responsible for
      ...
      <p>
        ...
        available&quot; basis. Crown CV makes no warranties, express or implied,
      ...
      <p>
        To the fullest extent permitted by law, Crown CV shall not be liable for
      ...
      <p>
        By using Crown CV, you acknowledge that you have read, understood, and
